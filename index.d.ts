...
declare function RedisGCRA(options: RedisGCRAOptions): {
  ...
  limit: (props: {
    ...
    /**
     * The number of requests remaining before hitting the monthly limit
     */
 ...
 */
export function defineNodeRedisScripts(
  redis: typeof Redis
): Record<string, ReturnType<typeof Redis.defineScript>>;
...
export type RedisGCRAOptions = {
  ...
  /**
   * The default monthly limit for for this limiter instance. If provided, must be a number greater than or equal to -1.
   *
   * @default -1
   */
  monthlyLimit?: number;
